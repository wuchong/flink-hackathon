...
public class KafkaSourceITCase {
	...
	public void testBasicRead() throws Exception {
		KafkaSource<PartitionAndValue> source = KafkaSource
			...
			.setClientIdPrefix("testBasicRead")
			.setTopics(Arrays.asList(TOPIC1, TOPIC2))
			.setDeserializer(new TestingKafkaDeserializer())
	...
	private static class TestingKafkaDeserializer implements KafkaDeserializer<PartitionAndValue> {
