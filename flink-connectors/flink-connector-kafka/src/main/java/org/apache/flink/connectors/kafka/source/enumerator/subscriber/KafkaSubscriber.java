...
public interface KafkaSubscriber extends Serializable {
	 ...
	 *
	 * @param consumer The consumer used to retrieve partition information.
	 ...
	 */
	PartitionChange getPartitionChanges(KafkaConsumer<?, ?> consumer, Set<TopicPartition> currentAssignment);
