...
public interface KafkaDeserializer<T> extends Serializable, ResultTypeQueryable<T> {
	...
	/**
	 * Wraps a Kafka {@link Deserializer} to a {@link KafkaDeserializer}.
	 * @param valueDeserializerClass the deserializer class used to deserialize the value.
	 * @param <V> the value type.
	 * @return A {@link KafkaDeserializer} that deserialize the value with the given deserializer.
	 */
	static <V> KafkaDeserializer<V> valueOnly(
	 ...
	 * @return A {@link KafkaDeserializer} that deserialize the value with the given deserializer.
	 */
	static <V, D extends Configurable & Deserializer<V>> KafkaDeserializer<V> valueOnly(
